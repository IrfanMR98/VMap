...
public final class addWorker_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      com.DAO Dao = null;
      synchronized (request) {
        Dao = (com.DAO) _jspx_page_context.getAttribute("Dao", PageContext.REQUEST_SCOPE);
        if (Dao == null){
          Dao = new com.DAO();
      ...
      out.write("                    <a class=\"nav-link active\" data-toggle=\"tab\" href=\"#home\">Register Worker</a>\n");
      out.write("                </li>\n");
      out.write("                <li class=\"nav-item\">\n");
      out.write("                    <a class=\"nav-link\" data-toggle=\"tab\" href=\"#menu1\">List Worker</a>\n");
      out.write("                </li>\n");
      out.write("\n");
      out.write("            </ul>\n");
      out.write("\n");
      ...
      out.write("                        <form class=\"asset\" action=\"processAdd.jsp\" method=\"post\">\n");
      out.write("\n");
      out.write("\n");
      out.write("                            <fieldset>\n");
      out.write("                                <input name=\"workerID\" placeholder=\"Worker ID\" type=\"text\" tabindex=\"1\" required autofocus>\n");
      out.write("                            </fieldset>\n");
      out.write("                            <fieldset>\n");
      out.write("                                <input name=\"firstName\" placeholder=\"First Name\" type=\"text\" tabindex=\"2\" required>\n");
      out.write("                            </fieldset>\n");
      out.write("                            <fieldset>\n");
      out.write("                                <input name=\"lastName\" placeholder=\"Last Name\" type=\"text\" tabindex=\"3\" required>\n");
      out.write("                            </fieldset>\n");
      out.write("                            <fieldset>\n");
      out.write("                                <input name=\"icno\" placeholder=\"Identification Card Number\" type=\"text\" tabindex=\"4\" required>\n");
      out.write("                            </fieldset>\n");
      out.write("                            <fieldset>\n");
      out.write("                                <input name=\"address\" placeholder=\"Address\" type=\"text\" tabindex=\"5\" required>\n");
      out.write("                            </fieldset>\n");
      out.write("                            <fieldset>\n");
      out.write("                                <input name=\"phoneNo\" placeholder=\"Phone Number\" type=\"text\" tabindex=\"6\" required>\n");
      out.write("                            </fieldset>\n");
      out.write("                            <fieldset>\n");
      out.write("                                <input name=\"position\" placeholder=\"Position\" type=\"text\" tabindex=\"7\" required>\n");
      out.write("\n");
      out.write("                            </fieldset>\n");
      out.write("                            <fieldset>\n");
      out.write("                                <input name=\"type_of_Worker\" placeholder=\"Type of Worker\" type=\"text\" tabindex=\"8\" required>\n");
      out.write("                            </fieldset>\n");
      out.write("                            <fieldset>\n");
      out.write("                                <input name=\"username\" placeholder=\"Username / Worker ID\" type=\"text\" tabindex=\"9\" required>\n");
      out.write("                            </fieldset>\n");
      out.write("                            <fieldset>\n");
      out.write("                                <input name=\"password\" placeholder=\"Password\" type=\"password\" tabindex=\"10\" required>\n");
      out.write("                            </fieldset>\n");
      out.write("\n");
      out.write("                            <br>\n");
      out.write("                            <fieldset>\n");
      ...
      out.write("                                    <th>Identification No</th>\n");
      out.write("                                    <th>Address</th>\n");
      out.write("                                    <th>Phone No</th>\n");
      out.write("                                    <th>Position</th>\n");
      out.write("                                    <th>Type of Worker</th>\n");
      ...
      out.write("                                <tr>\n");
      out.write("                                    <td>");
      out.print( WorkerAll.get(i).getWorkerID());
      out.write("</td>\n");
      out.write("                                    <td>");
      out.print( WorkerAll.get(i).getFirstName());
      out.write("</td>\n");
      out.write("                                    <td>");
      out.print( WorkerAll.get(i).getLastName());
      out.write("</td>\n");
      out.write("                                    <td>");
      out.print( WorkerAll.get(i).getIcno());
      out.write("</td>\n");
      out.write("                                    <td>");
      out.print( WorkerAll.get(i).getAddress());
      out.write("</td>\n");
      out.write("                                    <td>");
      out.print( WorkerAll.get(i).getPhoneNo());
      out.write("</td>\n");
      out.write("                                    <td>");
      out.print( WorkerAll.get(i).getPosition());
      out.write("</td> \n");
      out.write("                                    <td>");
      out.print( WorkerAll.get(i).getType_of_Worker());
      out.write("</td>\n");
      out.write("                                    <td>");
      out.print( WorkerAll.get(i).getUsername());
      out.write("</td>\n");
      out.write("                                    <td>");
      out.print( WorkerAll.get(i).getPassword());
      out.write("</td>\n");
      out.write("                                    <td> </td>\n");
      out.write("\n");
      out.write("                                    <td>\n");
      out.write("                                        <a style=\"margin-right: 10px;\" href=\"process-update-worker.jsp?workerID=");
      out.print( WorkerAll.get(i).getWorkerID());
      out.write("\"><i class=\"fa fa-edit\" style=\"font-size:20px\"></i></a>\n");
      out.write("                                        <a href=\"deleteProcess.jsp?workerID=");
      out.print( WorkerAll.get(i).getWorkerID());
